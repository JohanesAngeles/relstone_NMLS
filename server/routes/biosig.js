...
const BSI_CONFIG = {
  ssoUrl: process.env.BIOSIG_SSO_URL || 'https://sandbox.verifyexpress.com/interface/standard/nmls/relstone/ngrok/ssoinbound.aspx',
  ...
  callbackUrl: process.env.BIOSIG_CALLBACK_URL || 'https://www.relstonenmls.com/api/biosig/callback',
};
