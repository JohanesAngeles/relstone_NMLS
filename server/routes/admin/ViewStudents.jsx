            ...
            <div style={S.modalAvatar}>
              ...
              {student.is_online && (
                <div style={{
                  ...
                  background: '#22c55e', border: '2.5px solid #fff', borderRadius: '50%',
...
const S = {
  ...
  avatar:      { position: "relative", width:34, height:34, borderRadius:"50%", background:"rgba(0,180,180,0.12)", border:"1.5px solid rgba(0,180,180,0.28)", display:"flex", alignItems:"center", justifyContent:"center", color:"var(--rs-teal)", fontWeight:900, fontSize:14, flexShrink:0 },
  ...
  modalAvatar: { position: "relative", width:52, height:52, borderRadius:"50%", background:"linear-gradient(135deg,#091925,#054040)", border:"2px solid rgba(0,180,180,0.30)", display:"flex", alignItems:"center", justifyContent:"center", color:"var(--rs-teal)", fontWeight:900, fontSize:20, flexShrink:0 },
