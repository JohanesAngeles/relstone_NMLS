/**
 * seed_ca_dre_course.js
 * Drop this in: relstone_NMLS/server/seeders/
 * Run with:    node seeders/seed_ca_dre_course.js   (from the /server directory)
 *
 * COURSE STRUCTURE:
...
// ── PDF URLs ──────────────────────────────────────────────────────────
const DRE_TEXTBOOK_PDF = 'https://www.dropbox.com/scl/fi/28mt6j5wuud10ho8ajivf/8-Hour-SAFE-Comprehensive-Mortgage-Loan-Originator.pdf?rlkey=rbgei5ml4jn5rk1ae49uwmwx0&st=hqe1vqea&raw=1';
...
const courseData = {
  ...
  nmls_course_id:  'CE-CA-DRE-8HR',
  type:            'CE',
  credit_hours:    8,
  description:     'This 8-hour SAFE Act continuing education course covers federal mortgage law (3 hrs), ethics for MLOs (2 hrs), non-traditional mortgage lending (2 hrs), and mortgage origination (1 hr). Required annually for CA-DRE licensed Mortgage Loan Originators.',
  price:           99.00,
  states_approved: ['CA'],
  has_textbook:    false,
  textbook_price:  0,
  is_active:       true,
  pdf_url:         DRE_TEXTBOOK_PDF,
  ...
  modules: [
    ...
    // ── MODULE 1 ────────────────────────────────────────────────────
    {
      ...
      pdf_url: DRE_TEXTBOOK_PDF, pdf_start_page: 1, show_pdf_before_quiz: false,
      sections: [
    ...
    // ── MODULE 2 ────────────────────────────────────────────────────
    {
      ...
      pdf_url: DRE_TEXTBOOK_PDF, pdf_start_page: 25, show_pdf_before_quiz: false,
      sections: [
    ...
    // ── MODULE 3 ────────────────────────────────────────────────────
    {
      ...
      pdf_url: DRE_TEXTBOOK_PDF, pdf_start_page: 45, show_pdf_before_quiz: false,
      sections: [
    ...
    // ── MODULE 4 ────────────────────────────────────────────────────
    {
      ...
      pdf_url: DRE_TEXTBOOK_PDF, pdf_start_page: 60, show_pdf_before_quiz: false,
      sections: [
  ...
  final_exam: {
    title:              '8-HOUR SAFE COMPREHENSIVE: MORTGAGE LOAN ORIGINATOR — Final Exam',
    passing_score:      70,
...
const seed = async () => {
  try {
    ...
    await Course.deleteOne({ nmls_course_id: 'CE-CA-DRE-8HR' });
    console.log('🗑️  Removed existing CA-DRE course (if any)');
    ...
    console.log('\n🎯 Test at: /courses/CE-CA-DRE-8HR/learn');
    console.log('\n▶️  Run from /server dir:  node seeders/seed_ca_dre_course.js');
    console.log('\n✅ Done!');
