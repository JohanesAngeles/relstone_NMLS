/**
 * seed_tx_sml_course.js
 * Drop this in: relstone_NMLS/server/seeders/
 * Run with:    node seed_tx_sml_course.js   (from inside the /seeders directory)
 *
 * COURSE STRUCTURE:
...
// ── PDF URL ───────────────────────────────────────────────────────────
const TX_SML_PDF = 'https://www.dropbox.com/scl/fi/hpts4v36tg7rjw8kihot9/8-Hour-SAFE-Comprehensive-Mortgage-Loan-Originator.pdf?rlkey=ychdcvpc3gb4a1bjp03859h48&st=m1y59sly&raw=1';

// ── 70-Question Retry Bank ────────────────────────────────────────────
// Answer key: 1C 2C 3A 4B 5B 6B 7B 8B 9B 10B 11B 12B 13B 14B 15C
//             16A 17B 18B 19B 20B 21B 22B 23B 24A 25C 26B 27B 28B
...
// Answer key: 1C 2C 3A 4B 5B 6B 7B 8B 9B 10B
...
// ─────────────────────────────────────────────────────────────────────
const courseData = {
  title:           '8-HOUR SAFE COMPREHENSIVE: MORTGAGE LOAN ORIGINATOR (TX-SML)',
  nmls_course_id:  'CE-TX-SML-8HR',
  type:            'CE',
  credit_hours:    8,
  description:     'This 8-hour SAFE Act continuing education course covers federal mortgage law (3 hrs), ethics for MLOs (2 hrs), non-traditional mortgage lending (2 hrs), and mortgage origination (1 hr). Required annually for Texas SML licensed Mortgage Loan Originators.',
  price:           99.00,
  states_approved: ['TX'],
  has_textbook:    false,
  textbook_price:  0,
  ...
  modules: [
    ...
    // ── MODULE 1 ────────────────────────────────────────────────────
    {
      ...
      pdf_url: TX_SML_PDF, pdf_start_page: 1, show_pdf_before_quiz: false,
      sections: [
    ...
    // ── MODULE 2 ────────────────────────────────────────────────────
    {
      ...
      pdf_url: TX_SML_PDF, pdf_start_page: 25, show_pdf_before_quiz: false,
      sections: [
    ...
    // ── MODULE 3 ────────────────────────────────────────────────────
    {
      ...
      pdf_url: TX_SML_PDF, pdf_start_page: 45, show_pdf_before_quiz: false,
      sections: [
    ...
    // ── MODULE 4 ────────────────────────────────────────────────────
    {
      ...
      pdf_url: TX_SML_PDF, pdf_start_page: 60, show_pdf_before_quiz: false,
      sections: [
  ...
  final_exam: {
    title:              '8-HOUR SAFE COMPREHENSIVE: MORTGAGE LOAN ORIGINATOR (TX-SML) — Final Exam',
    passing_score:      70,
...
const seed = async () => {
  try {
    ...
    await Course.deleteOne({ nmls_course_id: 'CE-TX-SML-8HR' });
    console.log('🗑️  Removed existing TX-SML course (if any)');
    ...
    console.log('\n🎯 Test at: /courses/CE-TX-SML-8HR/learn');
    console.log('\n✅ Done!');
