 ...
 *   Step 9  📄 Lesson     — FINAL - CALIFORNIA DFPI (PDF review, no quiz)
...
const courseData = {
  ...
  type:            'CE',
  credit_hours:    8,
  description:     'This 8-hour SAFE Act continuing education course covers federal mortgage law (3 hrs), ethics for MLOs (2 hrs), non-traditional mortgage lending (2 hrs), and California state law & DFPI regulations (1 hr). Required annually for CA-DFPI licensed Mortgage Loan Originators.',
  price:           99.00,
  states_approved: ['CA'],
  has_textbook:    false,
  textbook_price:  0,
  is_active:       true,
  pdf_url:         CA_TEXTBOOK_PDF,
