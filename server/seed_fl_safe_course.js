 ...
 *   Step 9  📄 Lesson    — FINAL - FLORIDA (PDF textbook)
 *   Step 9b 📋 Checkpoint — FL Fundamentals (70 questions)
 *   Step 10 🏆 Final Exam — Official Final Exam (35 questions, verified answer key)
 *
 * PDF URLS:
 *   Modules 1–4 Textbook : 8-Hour FL SAFE Comprehensive - Annual MLO Fundamentals
 *   Module 5 Final PDF   : FINAL-FLORIDA.pdf
 */
...
// ── 70-Question FL Fundamentals Bank ─────────────────────────────────
...
const courseData = {
  ...
  description:
    ...
    'Florida state law & regulations (1 hr). Required annually for Florida-licensed ' +
  ...
  // ── Course-level PDF (8-Hour FL SAFE Comprehensive textbook) ──────
  ...
  modules: [
    ...
    {
      order:                4,
      title:                'Florida State Law and Regulations',
      credit_hours:         1,
      pdf_url:              FL_TEXTBOOK_PDF,
      show_pdf_before_quiz: false,
      sections: [
        '4.1 Overview of State Regulatory Authority in Florida',
        '4.2 State Continuing Education Requirements in Florida',
        ...
        'Module 4 Summary',
        'Case Study: The Unlicensed Originator',
      ],
      quiz: [
        { number:1, question:'Which agency regulates mortgage lenders in Florida?', options:['Department of Real Estate','Florida Department of Financial Regulation (FDFR)','Federal Reserve Board','Consumer Financial Protection Bureau'], correct_index:1 },
        { number:2, question:'What may occur if a Florida licensee fails to complete required CE before renewal?', options:['Automatic extension','No consequence if unintentional','License expiration or enforcement action','Provider responsibility only'], correct_index:2 },
        { number:3, question:'Which practice is prohibited under Florida mortgage law?', options:['Accurate loan disclosures','Truthful advertising','Misrepresentation of loan terms','Maintaining CE records'], correct_index:2 },
        { number:4, question:'Which system is used for submitting and maintaining mortgage license applications and renewals in Florida?', options:['State Licensing Portal','Florida Compliance Registry','Nationwide Multistate Licensing System (NMLS)','Federal Licensing Exchange'], correct_index:2 },
        { number:5, question:'Which of the following is a possible consequence of serious or repeated violations of Florida mortgage law?', options:['Mandatory vacation leave','License suspension or revocation','Reduced CE requirements','Automatic license transfer to another state'], correct_index:1 },
      ],
    },

    // ── MODULE 5: FINAL - FLORIDA ────────────────────────────────────
    // show_pdf_before_quiz: true → PDF Gate shown before 70-question exam
    // Modules 1–4 use the FL Textbook PDF
    // Module 5 uses the dedicated FINAL-FLORIDA.pdf
    {
      order:                5,
      title:                'FINAL - FLORIDA',
      credit_hours:         0,
      ...
      sections: [
        '8-HOUR FL SAFE COMPREHENSIVE: ANNUAL MLO FUNDAMENTALS',
        'Florida 70-Item Question Bank',
        'Review all four modules before attempting the fundamentals exam',
        'Covers: Federal Law · Ethics · Non-Traditional Lending · FL State Law',
      ],
...
const seed = async () => {
  try {
    ...
    console.log('   ─────────────────────────────────────────');
    console.log('\n📎 PDF Summary:');
    console.log(`   Modules 1–4 : 8-Hour FL SAFE Comprehensive - Annual MLO Fundamentals`);
    console.log(`   Module 5    : FINAL-FLORIDA.pdf`);
