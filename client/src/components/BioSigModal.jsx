...
// No action filter — just check if ANY recent verification exists for this course
useEffect(() => {
...
// No action filter — any recent verified=true for this course is enough
const startPolling = () => {
...
setStep('waiting');
startPolling(); // no argument needed anymore
} catch (err) {
        ...
        {failReason === 'failed' && (
          <>
            ...
            <div style={S.failGuideBox}>
              ...
              <div style={S.failGuideStep}>• If you continue to have issues, contact NMLS support at <strong>1-855-665-7123</strong>.</div>
            </div>
          </>
        )}
        ...
        {failReason === 'server' && (
          <>
            ...
            <div style={S.failGuideBox}>
              ...
              <div style={S.failGuideStep}>• If the issue persists, contact support.</div>
            </div>
          </>
        )}
