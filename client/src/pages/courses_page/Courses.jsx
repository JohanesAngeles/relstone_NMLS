        ...
        <div style={S.topbarInner}>
          <div style={S.left}>
            ...
            <div style={S.titleWrap}>
              ...
              <div style={S.subtitle}>Browse NMLS-approved PE and CE courses</div>
            </div>
          </div>
          ...
          <div style={S.filtersLeft}>
            <div style={S.searchWrap}>
              ...
              <input
                ...
                placeholder="Search courses, description, states…"
              />
            </div>
            ...
            <div style={S.filterWrap}>
              ...
              {(filters.type || filters.state || q.trim()) && (
                <button
                  type="button"
                  style={S.clearBtn}
                  onClick={() => {
                    setFilters({ type: "", state: "" });
                    setQ("");
                  }}
                >
                  Clear
...
const S = {
  ...
  cartBtn: {
    ...
    fontSize: 13,
    color: "rgba(11,18,32,0.82)",
    boxShadow: "0 10px 22px rgba(2,8,23,0.06)",
  },
  cartCount: {
    minWidth: 22,
    height: 22,
    ...
    display: "inline-grid",
    placeItems: "center",
    background: "rgba(46,171,254,0.14)",
    border: "1px solid rgba(46,171,254,0.22)",
    color: "var(--rs-dark)",
    fontWeight: 950,
    fontSize: 12,
  ...
  emptyCard: {
    ...
    borderRadius: 22,
    background: "#fff",
    border: "1px dashed rgba(2,8,23,0.18)",
    padding: 18,
  },
  ...
  drawer: {
    ...
    maxWidth: "92vw",
    background: "rgba(255,255,255,0.92)",
    borderLeft: "1px solid rgba(2,8,23,0.10)",
    boxShadow: "-20px 0 50px rgba(2,8,23,0.18)",
    zIndex: 60,
    display: "flex",
    flexDirection: "column",
    backdropFilter: "blur(10px)",
